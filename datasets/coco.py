...
coco_ids = [1, 2, 3, 4, 5, 6, 7]
coco_names=['trafficsignal', 'car', 'person', 'bicycle', 'trafficlight', 'bus', 'motorbike']
#{'trafficsignal': 1, 'car': 2, 'person': 3, 'bicycle': 4, 'trafficlight': 5, 'bus': 6, 'motorbike': 7}
...
rgb_mean = [0.382, 0.391, 0.391]
rgb_std = [0.319, 0.310, 0.306]
